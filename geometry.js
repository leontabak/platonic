...
exports.vector2D = function vector2D( x, y ) {
...
exports.vector3D = function vector3D( x, y, z ) {
    ...
    that.add = function( v ) {
        ...
        var z0 = this.getZ();
        var z1 = v.getZ();
        return vector2D( x0 + x1, y0 + y1, z0 + z1 );
    };
    ...
    that.scale = function( factor ) {
        ...
        var y = this.getY();
        var z = this.getZ();
        return vector2D( factor * x, factor * y, factor * z );
    };
...
exports.vector4D = function vector4D( x, y, z ) {
    // private instance variables
    var name = 'vector4D';
...
exports.matrix2x2 = function matrix2x2() {
    // private instance variables
    var name = 'matrix2x2';
    var m = [[1, 0], [0, 1]];
...
exports.matrix3x3 = function matrix3x3() {
    // private instance variables
    var name = 'matrix3x3';
...
exports.matrix4x4 = function matrix4x4() {
    // private instance variables
    var name = 'matrix4x4';
